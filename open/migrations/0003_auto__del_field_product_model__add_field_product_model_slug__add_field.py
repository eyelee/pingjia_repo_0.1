...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('open_product', 'model')

        # Adding field 'Product.model_slug'
        db.add_column('open_product', 'model_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.city_slug'
        db.add_column('open_product', 'city_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.region_slug'
        db.add_column('open_product', 'region_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('open_product', 'model',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.model_slug'
        db.delete_column('open_product', 'model_slug')

        # Deleting field 'Product.city_slug'
        db.delete_column('open_product', 'city_slug')

        # Deleting field 'Product.region_slug'
        db.delete_column('open_product', 'region_slug')
    ...
    models = {
        ...
        'open.product': {
            ...
            'model_slug': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
