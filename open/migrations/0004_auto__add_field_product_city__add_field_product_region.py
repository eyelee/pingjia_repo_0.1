...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.city'
        db.add_column('open_product', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.region'
        db.add_column('open_product', 'region',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.city'
        db.delete_column('open_product', 'city')

        # Deleting field 'Product.region'
        db.delete_column('open_product', 'region')
