...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.model_slug'
        db.alter_column('open_product', 'model_slug', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Product.brand_slug'
        db.alter_column('open_product', 'brand_slug', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
