...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.brand'
        db.add_column('open_source', 'brand',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source.model'
        db.add_column('open_source', 'model',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.brand'
        db.delete_column('open_source', 'brand')

        # Deleting field 'Source.model'
        db.delete_column('open_source', 'model')
