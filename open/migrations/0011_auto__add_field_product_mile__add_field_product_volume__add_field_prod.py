...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.mile'
        db.add_column('open_product', 'mile',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product.volume'
        db.add_column('open_product', 'volume',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product.color'
        db.add_column('open_product', 'color',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.control'
        db.add_column('open_product', 'control',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.mile'
        db.delete_column('open_product', 'mile')

        # Deleting field 'Product.volume'
        db.delete_column('open_product', 'volume')

        # Deleting field 'Product.color'
        db.delete_column('open_product', 'color')

        # Deleting field 'Product.control'
        db.delete_column('open_product', 'control')
