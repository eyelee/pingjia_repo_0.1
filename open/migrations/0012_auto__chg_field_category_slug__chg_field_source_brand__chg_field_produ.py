...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('open_category', 'slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Source.brand'
        db.alter_column('open_source', 'brand', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Product.region_slug'
        db.alter_column('open_product', 'region_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Product.city_slug'
        db.alter_column('open_product', 'city_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Product.brand_slug'
        db.alter_column('open_product', 'brand_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'City.slug'
        db.alter_column('open_city', 'slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Category.slug'
        db.alter_column('open_category', 'slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Source.brand'
        db.alter_column('open_source', 'brand', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Product.region_slug'
        db.alter_column('open_product', 'region_slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Product.city_slug'
        db.alter_column('open_product', 'city_slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Product.brand_slug'
        db.alter_column('open_product', 'brand_slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'City.slug'
        db.alter_column('open_city', 'slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
