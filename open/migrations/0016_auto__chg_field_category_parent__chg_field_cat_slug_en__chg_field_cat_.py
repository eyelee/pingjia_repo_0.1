...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('open_category', 'parent', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Cat.slug_en'
        db.alter_column('open_cat', 'slug_en', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Cat.slug_cn'
        db.alter_column('open_cat', 'slug_cn', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Product.model_slug'
        db.alter_column('open_product', 'model_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Category.parent'
        db.alter_column('open_category', 'parent', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Cat.slug_en'
        db.alter_column('open_cat', 'slug_en', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Cat.slug_cn'
        db.alter_column('open_cat', 'slug_cn', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Product.model_slug'
        db.alter_column('open_product', 'model_slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
