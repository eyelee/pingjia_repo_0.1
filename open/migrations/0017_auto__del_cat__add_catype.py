...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Cat'
        db.delete_table('open_cat')

        # Adding model 'Catype'
        db.create_table('open_catype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug_cn', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('slug_en', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('open', ['Catype'])


    def backwards(self, orm):
        # Adding model 'Cat'
        db.create_table('open_cat', (
            ('slug_en', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('slug_cn', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('open', ['Cat'])

        # Deleting model 'Catype'
        db.delete_table('open_catype')
