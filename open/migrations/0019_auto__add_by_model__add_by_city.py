...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'By_model'
        db.create_table('open_by_model', (
            ...
            ('brand_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('model_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
        ))
        db.send_create_signal('open', ['By_model'])

        # Adding model 'By_city'
        db.create_table('open_by_city', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('avg_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1, blank=True)),
            ('units', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('city_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('brand_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('model_slug', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
        ))
        db.send_create_signal('open', ['By_city'])


    def backwards(self, orm):
        # Deleting model 'By_model'
        db.delete_table('open_by_model')

        # Deleting model 'By_city'
        db.delete_table('open_by_city')
