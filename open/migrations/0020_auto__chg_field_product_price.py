...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('open_product', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Product.price'
        db.alter_column('open_product', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
