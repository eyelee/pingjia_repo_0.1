...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'By_model', fields ['model_slug']
        db.create_index('open_by_model', ['model_slug'])

        # Adding index on 'By_model', fields ['year']
        db.create_index('open_by_model', ['year'])

        # Adding index on 'By_model', fields ['brand_slug']
        db.create_index('open_by_model', ['brand_slug'])

        # Adding index on 'Product', fields ['model_slug']
        db.create_index('open_product', ['model_slug'])

        # Adding index on 'Product', fields ['region_slug']
        db.create_index('open_product', ['region_slug'])

        # Adding index on 'Product', fields ['city_slug']
        db.create_index('open_product', ['city_slug'])

        # Adding index on 'Product', fields ['brand_slug']
        db.create_index('open_product', ['brand_slug'])

        # Adding index on 'By_city', fields ['city_slug']
        db.create_index('open_by_city', ['city_slug'])

        # Adding index on 'By_city', fields ['model_slug']
        db.create_index('open_by_city', ['model_slug'])

        # Adding index on 'By_city', fields ['brand_slug']
        db.create_index('open_by_city', ['brand_slug'])


    def backwards(self, orm):
        # Removing index on 'By_city', fields ['brand_slug']
        db.delete_index('open_by_city', ['brand_slug'])

        # Removing index on 'By_city', fields ['model_slug']
        db.delete_index('open_by_city', ['model_slug'])

        # Removing index on 'By_city', fields ['city_slug']
        db.delete_index('open_by_city', ['city_slug'])

        # Removing index on 'Product', fields ['brand_slug']
        db.delete_index('open_product', ['brand_slug'])

        # Removing index on 'Product', fields ['city_slug']
        db.delete_index('open_product', ['city_slug'])

        # Removing index on 'Product', fields ['region_slug']
        db.delete_index('open_product', ['region_slug'])

        # Removing index on 'Product', fields ['model_slug']
        db.delete_index('open_product', ['model_slug'])

        # Removing index on 'By_model', fields ['brand_slug']
        db.delete_index('open_by_model', ['brand_slug'])

        # Removing index on 'By_model', fields ['year']
        db.delete_index('open_by_model', ['year'])

        # Removing index on 'By_model', fields ['model_slug']
        db.delete_index('open_by_model', ['model_slug'])
