...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'procedure_mark'
        db.create_table('open_procedure_mark', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('mark_id', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal('open', ['procedure_mark'])

        # Adding field 'Category.keywords'
        db.add_column('open_category', 'keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'procedure_mark'
        db.delete_table('open_procedure_mark')

        # Deleting field 'Category.keywords'
        db.delete_column('open_category', 'keywords')
