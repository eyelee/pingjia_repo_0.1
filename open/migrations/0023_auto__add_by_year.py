...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'By_year'
        db.create_table('open_by_year', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('avg_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1, blank=True)),
            ('price_range', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('units', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True, blank=True)),
            ('brand_slug', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True)),
            ('model_slug', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True)),
        ))
        db.send_create_signal('open', ['By_year'])


    def backwards(self, orm):
        # Deleting model 'By_year'
        db.delete_table('open_by_year')
    ...
    models = {
        ...
        'open.by_year': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model_slug': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'price_range': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'units': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'year': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True', 'blank': 'True'})
        },
        'open.category': {
