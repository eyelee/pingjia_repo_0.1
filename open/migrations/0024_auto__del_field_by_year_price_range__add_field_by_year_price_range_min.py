...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'By_year.price_range'
        db.delete_column('open_by_year', 'price_range')

        # Adding field 'By_year.price_range_min'
        db.add_column('open_by_year', 'price_range_min',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'By_year.price_range_max'
        db.add_column('open_by_year', 'price_range_max',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'By_year.price_range'
        db.add_column('open_by_year', 'price_range',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'By_year.price_range_min'
        db.delete_column('open_by_year', 'price_range_min')

        # Deleting field 'By_year.price_range_max'
        db.delete_column('open_by_year', 'price_range_max')
