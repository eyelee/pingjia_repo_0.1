...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'City', fields ['parent']
        db.create_index('open_city', ['parent'])

        # Adding index on 'City', fields ['quhao']
        db.create_index('open_city', ['quhao'])

        # Adding index on 'City', fields ['pinyin']
        db.create_index('open_city', ['pinyin'])

        # Adding index on 'City', fields ['slug']
        db.create_index('open_city', ['slug'])


    def backwards(self, orm):
        # Removing index on 'City', fields ['slug']
        db.delete_index('open_city', ['slug'])

        # Removing index on 'City', fields ['pinyin']
        db.delete_index('open_city', ['pinyin'])

        # Removing index on 'City', fields ['quhao']
        db.delete_index('open_city', ['quhao'])

        # Removing index on 'City', fields ['parent']
        db.delete_index('open_city', ['parent'])
    ...
    models = {
        ...
        'open.category': {
            ...
            'parent': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '32', 'null': 'True', 'blank': 'True'}),
        ...
        'open.city': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '50', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'pinyin': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'quhao': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['open.Source']"}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        'open.procedure_mark': {
