...
urlpatterns = patterns("",
    ...
    ("^(?P<brand_slug>[-\w]+)/(?P<model_slug>[-\w]+)/(?P<year>\d+)/$","open.views.accurate_products"),
    ("^(?P<brand_slug>[-\w]+)/(?P<model_slug>[-\w]+)/$","open.views.accurate_products"),
    ("^(?P<brand_slug>[-\w]+)/$","open.views.brand"),
